...
//this version uses a vectorized distance function instead of euclidean_squared
//vectorized calculations only done with float, int8, or uint8 (will NOT vectorize with double)
//this version takes in the centers as floats, not as doubles**
